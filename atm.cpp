...
bool userAuthenticated; // whether user is authenticated
	...
	int Screen; // ATM's screen
	int Keypad; // ATM's keypad
	int CashDispenser; // ATM's cash dispenser
	int DepositSlot; // ATM's deposit slot
	int BankDatabase; // account information database
